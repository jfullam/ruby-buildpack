...
module RbConfig
  RUBY_VERSION == "2.1.0" or
    raise "ruby lib version (2.1.0) doesn't match executable version (#{RUBY_VERSION})"
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/app/vendor/ruby-2.1.0")
  ...
  CONFIG["configure_args"] = " '--disable-install-doc' '--prefix' '/app/vendor/ruby-2.1.0' '--enable-load-relative'"
  ...
  CONFIG["RUBY_RELEASE_DATE"] = "2013-12-25"
  CONFIG["RUBY_PROGRAM_VERSION"] = "2.1.0"
  CONFIG["target_alias"] = ""
  CONFIG["host_alias"] = ""
  CONFIG["build_alias"] = ""
